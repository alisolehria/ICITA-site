            ...
            <div className="row">
              <div className="col text-center">
                ...
                <div className="intro_left_content text_left">
                  <p align="left">
                    The purpose of ICITA is to provide a platform for academics
                    and professionals in computer technology to{" "}
                    <b>
                      publish, present, meet, exchange ideas, and establish
                      professional networks.
                    </b>{" "}
                    It is a forum for specific disciplinary research, as well as
                    on multi-disciplinary studies.{" "}
                  </p>
                  <p align="left">
                    Topics for publication and presentation can include, but are
                    not limited to the following research and development
                    areas/fields:
                  </p>
