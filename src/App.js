...
<header class="header">
    <nav class="navbar navbar-dark navbar-expand-md">
     ...
     {/* <div class="logo navbar-header">
      ...
      <div class="logo">
        <a href="#">
          <span>ICITA<span>2021</span></span>
      ...
      <div class="collapse navbar-collapse"  id="navbarNav"  >
        ...
        <ul class="navbar-nav">
          <li className={activeClass("/~am29/react-b")}><Link to="/">Home</Link></li>
          <li className={activeClass("/callforpapers")}><Link to="/callforpapers">Call for Papers</Link></li>
          <li className={activeClass("/previousconferences")}><Link to="/previousconferences">Previous Conferences</Link></li>
          <li className={activeClass("/technicalcommittee")}><Link to="/technicalcommittee">Technical Committee</Link></li>
          <li className={activeClass("/organizers")}><Link to="/organizers">Organizers</Link></li>
          <li className={activeClass("/previouslistings")}><Link to="/previouslistings">Previous Listings</Link></li>
        </ul>
      ...
      <div class="row">
        <div class="col text-center">
          <div class="section_title_container text-center">
            <div class="section_title"><h1>The Conference</h1></div>
          </div>
